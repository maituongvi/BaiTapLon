...
public class TestingHamThemPhong {
    private String ma;
    private String soNguoi,loai,gia;
    private boolean t, f;
    private boolean expected;
    private TimKiemPhongController tk;
    public TestingHamThemPhong(String ma, String soNguoi, String loai, String gia, boolean t, boolean f, boolean expected){
        this.ma = ma;
    ...
    public static Collection testData(){
        return Arrays.asList(new Object[][]{
            ...
            //Đúng
            {"130000", "2", "A", "123457", true, false, true},
